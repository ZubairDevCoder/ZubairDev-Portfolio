...
import { FaLinkedinIn, FaGithub, FaYoutube, FaFacebook } from "react-icons/fa6";
...
// Glow animation for social icons
const glowVariants = {
...
const Home = React.forwardRef((props, ref) => {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="h-auto w-full relative overflow-hidden bg-black py-10"
    >
      <ParticleBackground />
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 py-20">
        {/* Left content */}
        <motion.div
        ...
        >
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
              Hello, I&apos;m
              <br />
              <span className="text-white font-bold text-5xl lg:whitespace-nowrap">
                Muhammad Zubair
              </span>
            </motion.h1>
            ...
            >
              I am a Full Stack Developer specializing in Next.js, React, and
              SaaS Architecture. Experienced in building production-ready web
              applications with scalable backend systems, admin dashboards,
              authentication systems, and optimized performance. Passionate
              about delivering real-world deployable solutions with clean UI and
              structured code.
            </motion.p>
            ...
            >
              <a
                href="#projects"
                className="px-6 py-3 rounded-full text-lg font-medium text-white bg-gradient-to-r from-[#1CD8D2] via-[#00bf8f] to-[#302b63] shadow-lg hover:scale-105 transition-all"
              >
                View My Work
              </a>
              <a
                href="/MuhammadZubair_Resume.pdf"
                download
        ...
        >
          <div
            className="absolute top-1/2 -translate-y-1/2 pointer-events-none py-10"
            style={{
              right: "10px",
          ...
          />
          <Image
            src="/webdeveloperlogo.png"
            alt="Muhammad Zubair Avatar"
            width={420}
            height={400}
